...
if [ "$HAS_COMPLETION" ]; then
  ...
  PS1='`if [[ \$? = "0" ]]; then echo "\[\033[01;33m\]\t"; else echo "\[\033[31m\]>>> \t <<<"; fi` \[\033[01;32m\]\u@\[\033[01;33m\]\h:\[\033[01;32m\]\w\[\033[01;33m\]$(__git_ps1)\n\[\033[01;32m\]# \[\033[00m\]'
else
  PS1='`if [[ \$? = "0" ]]; then echo "\[\033[01;33m\]\t"; else echo "\[\033[31m\]>>> \t <<<"; fi` \[\033[01;32m\]\u@\[\033[01;33m\]\h:\[\033[01;32m\]\w\n\[\033[01;32m\]# \[\033[00m\]'
fi
